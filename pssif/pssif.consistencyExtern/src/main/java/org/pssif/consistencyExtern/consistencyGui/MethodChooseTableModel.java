...
public class MethodChooseTableModel extends AbstractTableModel {
	 ...
	 */
	private static final String[] COLUMN_NAMES = { "Method Name", "Method Type", "Weight",
			"Active" };
	...
	private static final int COLUMN_IDX_METHODTYPE = 1;
	private static final int COLUMN_IDX_WEIGHT = 2;
	private static final int COLUMN_IDX_ACTIVE = 3;
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		} else if (columnIndex == COLUMN_IDX_METHODTYPE)
		{
			return method.getMatchMethod().getType();
		} else if (columnIndex == COLUMN_IDX_WEIGHT) {
	...
	public void setValueAt(final Object value, final int rowIndex,
		...
		if (columnIndex == COLUMN_IDX_WEIGHT) {
