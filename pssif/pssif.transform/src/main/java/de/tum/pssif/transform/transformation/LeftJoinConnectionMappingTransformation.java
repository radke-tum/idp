...
import de.tum.pssif.transform.transformation.joined.LeftJoinedConnectionMapping;
...
public class LeftJoinConnectionMappingTransformation extends AbstractTransformation {
  ...
  public LeftJoinConnectionMappingTransformation(EdgeType baseType, ConnectionMapping baseMapping, EdgeType joinedType,
  ...
  public void apply(View view) {
    ...
    actualBaseType.addMapping(new LeftJoinedConnectionMapping(actualBaseType, actualBaseMapping, targetMapping, actualJoinedMapping));
  }
