	...
	public void showPopup(MyNode node) {
		...
		while (iterator.hasNext()) {
			...
			if (!(attr.getName().equalsIgnoreCase(PSSIFConstants.BUILTIN_ATTRIBUTE_VALIDITY_START) ||
					attr.getName().equalsIgnoreCase(PSSIFConstants.BUILTIN_ATTRIBUTE_VALIDITY_END) || attr.getName().equalsIgnoreCase(PSSIFConstants.BUILTIN_ATTRIBUTE_GLOBAL_ID)
					|| attr.getName().equalsIgnoreCase(PSSIFConstants.BUILTIN_ATTRIBUTE_ID))) {
