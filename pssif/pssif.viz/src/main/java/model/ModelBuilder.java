...
public class ModelBuilder {
	...
	/**
	 * Add a new Junction which was created through the Gui
	 * 
	 * @param nodeName
	 *            The name of the new Node
	 * @param type
	 *            The type of the new Node
	 */
	public static MyJunctionNode addNewJunctionNodeFromGUI(String nodeName, MyJunctionNodeType type) {
		if (activeModel != null)
			return activeModel.addNewJunctionNodeFromGUI(nodeName, type);
