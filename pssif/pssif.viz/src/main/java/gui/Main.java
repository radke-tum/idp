...
public class Main {
	...
	public Main() {
		frame = new JFrame(
				"Product Service Systems - Integration Framework ---- Visualization");
	...
	private JMenuBar createFileMenu() {
		...
		newProject.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				ReqToolReqistry.getInstance().post(
						new CreateSpecProjectEvent(frame));
				if (true) {
					// Model model = new Model();
					// ModelBuilder.addModel(ModelBuilder.getMetamodel(),
					// model);
					// Create the Views
