...
\begin{figure}[h]
\centering
\includegraphics[scale=0.2]{figures/generic-graph-sketch.jpg}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.2]{figures/vsdx-sketch.jpg}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.2]{figures/2-level-process-sketch.jpg}
