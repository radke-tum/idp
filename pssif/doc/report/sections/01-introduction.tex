...
\item considers the following domain-specific languages relevant:
	\begin{itemize}
	\item Event-driven Process Chain (EPC) \cite{ref:epk} Diagrams
	\item Business Process Modelling Notation (BPMN) \cite{ref:bpmn} Diagrams
	\item Flow-oriented Functional Modelling (FFM) \cite{ref:ufm} Diagrams modelled using the BOOGGIE-Tool (Bringing Object-oriented Graph Grammars into Engineering)
	\item Systems Modelling Language for Mechatronics (SysML4Mechatronics) \cite{ref:sysml} Diagrams and,
	\end{itemize}
