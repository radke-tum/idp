...
public class ModelTest {
	...
	public void init() {
		...
		metamodel.create("containment", "contains", hardware,
				MultiplicityContainer.of(0, UnlimitedNatural.UNLIMITED),
				"contained in", hardware, MultiplicityContainer.of(0, 1));
		metamodel.create("containment", "contains", hardware,
				MultiplicityContainer.of(0, UnlimitedNatural.UNLIMITED),
				"contained in", software, MultiplicityContainer.of(0, 1));
		metamodel.create("containment", "contains", software,
				MultiplicityContainer.of(0, UnlimitedNatural.UNLIMITED),
				"contained in", software, MultiplicityContainer.of(0, 1));
	...
	public void test() {
		...
		Multimap<EdgeEnd, Node> connections = ArrayListMultimap.create();
