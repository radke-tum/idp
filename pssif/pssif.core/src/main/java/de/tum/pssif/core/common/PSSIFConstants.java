...
public final class PSSIFConstants {
  ...
  public static final String META_MODEL_RDF_PATH = 
		  System.getProperty("user.dir") + File.separator + "Meta-Model.rdf";
  
  public static final String Meta_Model_XML_PATH = 
		  System.getProperty("user.dir") + File.separator + "Meta-Model.xml";
  
  public static final String NODE_POSITION_FOLDER_PATH = 
		  System.getProperty("user.dir") + File.separator + "SavedPositions" + File.separator;
  
  
  public static final String NODE_POSITION_LAST_PATH = 
		  NODE_POSITION_FOLDER_PATH +  "nodePositionLast";
